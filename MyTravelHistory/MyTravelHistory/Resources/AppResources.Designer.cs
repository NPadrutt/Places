...
namespace MyTravelHistory.Resources {
    ...
    public class AppResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Places needs the windows phone locationservice to determine you position and calculate the address of this position. For this process we have to send location data to Microsoft (you&apos;ll find the privacy statement of Microsoft in the phone settings - location). We don&apos;t store any location data on our own server.
        ///
